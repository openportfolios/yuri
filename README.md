...
Template baseado no portfolio de [Yuri Miguel](https://yuri.dev/) acessível em [openportfolios.com.br/yuri](https://openportfolios.com.br/yuri).
...
4. Publique o projeto em alguma plataforma (veja [DEPLOY.md](DEPLOY.md)).
